...
matplot(1:6,perf.cond[1:6,1:4],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
...
matplot(1:6,perf.cond[1:6,5:8],type="l",xaxt="n",xlab="",ylab="",yaxt="n", col = gray((1:4)/8),
        xlim=c(0.7,6.2),ylim=c(0,110),lty = c(1,5,6,2), cex = 1.5, lwd = c(3,4.5,3,4), las = 1)
matplot(1:6,perf.cond[1:6,9:11],type="l",xaxt="n",xlab="",ylab="",yaxt="n", col = gray(c(1,3,4)/8), 
        xlim=c(0.7,6.2),ylim=c(0,110),lty = c(1,6,2), cex = 1.5, lwd = c(3,3,4), las = 1)
...
legend(-2,-40,c("Wide-ML","Long-ML", "Wide-Bayes","Long-Bayes"), col = gray((1:4)/8),
       lty = c(1,5,6,2),lwd = c(3,4.5,3,4),ncol=2, seg.len = 5, cex = 1.1)
...
par(mfrow=c(3,3),mar=c(0,0,0,0),oma=c(8,6,4,6),xpd=NA)
matplot(1:6,perf.cond[1:6,12:15],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
        xlim=c(0.7,6.2),ylim=c(0,110), cex = 1.5, lwd = c(3,4.5,3,4), las = 1)
...
par(mfrow=c(3,3),mar=c(0,0,0,0),oma=c(8,6,4,6),xpd=NA)
matplot(1:6,perf.cond[1:6,23:26],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
        xlim=c(0.7,6.2),ylim=c(0,110), cex = 1.5, lwd = c(3,4.5,3,4), las = 1)
...
par(mfrow=c(3,3),mar=c(0,0,0,0),oma=c(8,6,4,6),xpd=NA)
matplot(1:6,perf.cond[1:6,34:37],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
        xlim=c(0.7,6.2),ylim=c(0,110), cex = 1.5, lwd = c(3,4.5,3,4), las = 1)
...
for(j in 2:9){
  ...
  par(mfrow=c(3,3),mar=c(0,0,0,0),oma=c(8,6,4,6),xpd=NA)
  matplot(1:6,bias.cond[1:6,1:4],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
...
for(j in 2:9){
  ...
  par(mfrow=c(3,3),mar=c(0,0,0,0),oma=c(8,6,4,6),xpd=NA)
  matplot(1:6,se.psd.cond[1:6,1:4],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
          xlim=c(0.7,6.2),ylim=c(ylimits.down[j-1],ylimits.up[j-1]), cex = 1.5, lwd = c(3,4.5,3,4), las = 1)
  abline(h = 0, xpd = FALSE, col = rgb(.211, .211, .211, .25))
...
matplot(1:6,Ucon.cond[1:6,],type="l",lty = c(5,6,2),xaxt="n",xlab="",ylab="", col = gray((2:4)/8),
...
legend(1.5,ylimits.down*legend.factor,c("Long-ml", "Wide-Bayes","Long-Bayes"), col = gray((2:4)/8),
       lty = c(5,6,2),lwd = c(4.5,3,4),ncol=1, seg.len = 5, cex = 1)
...
par(mfrow=c(2,2),mar=c(0,0,0,0),oma=c(8,6,2,2),xpd=NA)
matplot(1:6,Upred.cond[1:6,],type="l",lty = c(1,6,2),xaxt="n",xlab="",ylab="", col = gray((c(1,3,4))/8),
...
legend(1.5,ylimits.down*legend.factor,c("Wide-ml", "Wide-Bayes","Long-Bayes"), col = gray((c(1,3,4))/8),
       lty = c(1,6,2),lwd = c(3,3,4),ncol=1, seg.len = 5, cex = 1)
mtext(ylabel, 2, outer=TRUE, line=4)
mtext("Number of Measurement Times", 1, at=1/4, outer=TRUE, line=4, cex=0.8)
mtext(expression(""%*%""), 1, at=1/4, outer=TRUE, line=5, cex=0.8)
mtext("Percentage of Missingness", 1, at=1/4, outer=TRUE, line=6, cex=0.8)
...
par(mfrow=c(2,2),mar=c(0,0,0,0),oma=c(8,6,2,2),xpd=NA)
matplot(1:6,Ucon.cond[1:6,],type="l",lty = c(1,5,6,2),xaxt="n",xlab="",ylab="", col = gray((1:4)/8),
...
legend(-0.3,ylimits.down*legend.factor,c("Wide-ml","Long-ml","Wide-Bayes","Long-Bayes"), col = gray((1:4)/8),
       lty = c(1,5,6,2),lwd = c(3,4.5,3,4),ncol=2, seg.len = 5, cex = 1)
mtext(ylabel, 2, outer=TRUE, line=4)
...
legend(1.5,ylimits.down*legend.factor,c("Wide-ml", "Wide-Bayes","Long-Bayes"), col = gray((c(1,3,4))/8),
       lty = c(1,6,2),lwd = c(3,3,4),ncol=1, seg.len = 5, cex = 1.1)
mtext(ylabel, 2, outer=TRUE, line=4)
mtext("Number of Measurement Times", 1, at=1/4, outer=TRUE, line=4, cex=0.8)
mtext(expression(""%*%""), 1, at=1/4, outer=TRUE, line=5, cex=0.8)
mtext("Percentage of Missingness", 1, at=1/4, outer=TRUE, line=6, cex=0.8)

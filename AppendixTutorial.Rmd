...
To prepare the environment for the next analyses three packages have to be load: 
...
This can take a while, especially is the estimation method is "BAYES". By default, the function `write.Mplus.options` uses 4 processors, 4 chains, and 10 thinning.
